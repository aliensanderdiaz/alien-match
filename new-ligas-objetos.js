const LIGAS_OBJETOS = [
    ...
    {
      nombreFlashcore:
        "BÉLGICA - Jupiler Pro League - Conference League - Play Offs",
      nombreWplay: "BÉLGICA - 1RA DIVISIÓN A",
      abreviado: "YE-BEL1",
      codigoWplay: 19372,
      mitad: true,
    ...
    {
      nombreFlashcore:
        "NORTE, CENTROAMÉRICA Y CARIBE - Mundial - Clasificación - Segunda fase",
      nombreWplay: "WORLD CUP 2026 - CONCACAF QUALIFIERS",
      abreviado: "M-CONC",
      codigoWplay: 310774,
      mitad: false,
    ...
    {
      nombreFlashcore:
        "NORTE, CENTROAMÉRICA Y CARIBE - CONCACAF Nations League - Liga A - Playoffs",
      nombreWplay: "NATIONS LEAGUE PARTIDOS",
      abreviado: "CNAT",
      codigoWplay: 601779,
      mitad: false,
    ...
    {
      nombreFlashcore:
        "NORTE, CENTROAMÉRICA Y CARIBE - CONCACAF Nations League - Liga A",
      nombreWplay: "NATIONS LEAGUE PARTIDOS",
      abreviado: "CNAT",
      codigoWplay: 601779,
      mitad: false,
    ...
    {
      nombreFlashcore:
        "NORTE, CENTROAMÉRICA Y CARIBE - CONCACAF Nations League - Liga B",
      nombreWplay: "NATIONS LEAGUE PARTIDOS",
      abreviado: "CNAT",
      codigoWplay: 601779,
      mitad: false,
    ...
    {
      nombreFlashcore:
        "NORTE, CENTROAMÉRICA Y CARIBE - CONCACAF Nations League - Liga C",
      nombreWplay: "NATIONS LEAGUE PARTIDOS",
      abreviado: "CNAT",
      codigoWplay: 601779,
      mitad: false,
    ...
    {
      nombreFlashcore:
        "ÁFRICA - Copa de África de Naciones - Clasificación - Preliminar",
    ...
    {
      nombreFlashcore:
        "URUGUAY - Segunda División - Torneo Competencia - Play Offs",
      nombreWplay: "URUGUAY - SEGUNDA DIVISION",
      abreviado: "ZA-URU2",
      codigoWplay: 26834,
      mitad: false,
    ...
    {
      nombreFlashcore:
        "NORTE, CENTROAMÉRICA Y CARIBE - Gold Cup Women - Playoffs",
      nombreWplay: "",
      abreviado: "ZM-GOLD",
      codigoWplay: 1001780,
      mitad: true,
    ...
    {
      nombreFlashcore:
        "PAÍSES BAJOS - Eredivisie - Conference League - Play Offs",
      nombreWplay: "HOLANDA - EREDIVISIE",
      abreviado: "YE-HOL1",
      codigoWplay: 19358,
      mitad: true,
    ...
    {
      nombreFlashcore:
        "REPÚBLICA CHECA - FORTUNA:LIGA - Conference League - Play Offs",
      nombreWplay: "REPÚBLICA CHECA - FIRST LEAGUE",
      abreviado: "YE-REP1",
      codigoWplay: 19403,
      mitad: false,
    ...
    {
      nombreFlashcore:
        "URUGUAY - Primera División - Torneo Intermedio - Playoffs",
      nombreWplay: "URUGUAY - PRIMERA DIVISIÓN",
      abreviado: "ZA-URU1",
      codigoWplay: 19398,
      mitad: false,
...
const codigosWplay = LIGAS_OBJETOS.map(liga => liga.codigoWplay)
const codigosWplayNoRepeat = [...new Set(codigosWplay)]
codigosWplayNoRepeat.sort()

const newLigas = codigosWplayNoRepeat.map(codigo => {
    let ligas = LIGAS_OBJETOS.filter(liga => liga.codigoWplay === codigo)
    // console.log({ ligas })
    let nombresFlashscore = [...new Set(ligas.map(liga => liga.nombreFlashcore))]
    let nombresWplay = [...new Set(ligas.map(liga => liga.nombreWplay))]
    // if (nombresWplay.length > 1) {
    //     console.log(nombresWplay)
    // }
    return {
        nombresFlashscore,
        nombresWplay,
        abreviado: ligas[0].abreviado,
        codigoWplay: ligas[0].codigoWplay,
        mitad: ligas[0].mitad,
        favorito: ligas[0].favorito,
        codigoBetplay: ligas[0].codigoBetplay,
    }
})
